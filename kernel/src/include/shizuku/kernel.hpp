...
private:
  shizuku::types::kernel &wrapping_kernel;
  kernel_api_for_super_object(kernel &kernel) : wrapping_kernel{kernel} {}
...
class kernel {
private:
  friend shizuku::cpu_driver;
  friend shizuku::types::kernel_api_for_super_object;
