...
api_result<size_t> kernel::create_object(shizuku::string const &name,
  ...
  if (auto current_thread =
    ...
    if (auto current_object = current_thread->parent_object.lock()) {
      ...
      object_tree.insert_or_assign(
          (size_t)target_id,
          shizuku::object_shared_ptr{new object{
              target_id, creator_id, init_method, arg1, arg2, super_object}});
      shizuku::object_shared_ptr created_object =
